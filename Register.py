...
Hostel_image = Ctk.CTkImage(light_image=Image.open('images\\hostel regisetr.jpg'),
                                  size=(500, screen_height))

# add `from PIL import Image` on top
Hostel_logo = Ctk.CTkImage(light_image=Image.open('images\\griha-high-resolution-logo.png'),
                                  size=(50, 40))
...
Fav_food_entry= Ctk.CTkEntry(master=Registerpage, placeholder_text="Your Favrouit Food*", width=300, height=40,
                                border_color="light gray", corner_radius=15)
Fav_food_entry.place(relx=0.4, rely=0.7)

Pet_name_entry= Ctk.CTkEntry(master=Registerpage, placeholder_text="Your pet name", width=300, height=40, 
