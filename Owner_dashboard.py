...
# Linear_image = Ctk.CTkImage(light_image=Image.open('Linear.png'), size=(screen_width, screen_height))
...
#   Complaint_btn= Ctk.CTkButton(master=Menu_frame, width=385, height=60, fg_color="#3FB5CB", corner_radius=10, bg_color="white", font=("bold",15),
#                      text="Complaint", text_color="black", command=lambda: toggle_button("Complaint",complaint))
#   Complaint_btn.place(relx=0, rely=0.5)
...
#   Emergency_btn.place(relx=0, rely=0.6)
...
#                      text="Setting", text_color="black", command=lambda: toggle_button("Setting", setting))
#   Setting_btn.place(relx=0, rely=0.7)

#   menu_button=[Appeared_btn,Report_btn, Complaint_btn,Emergency_btn, Setting_btn, Room_btn]
...
# def Report():
#     Report_frame= Ctk.CTkFrame(master=Homepage, width=(screen_width-350), height=(screen_height-200), fg_color="#746cb4")
#     Report_frame.place(relx=0.2, rely=0.35)

#     Hmepage_background = Ctk.CTkImage(light_image=Image.open('Homepage_background.png'),
#                                         size=(screen_width-350, screen_height-100))
#     Homepage_image_label= Ctk.CTkLabel(master=Report_frame, image=Hmepage_background,bg_color="transparent", text="")
...
# def Appeared():
#    Appeared_frame= Ctk.CTkFrame(master=Homepage, width=(screen_width-350), height=(screen_height-200), fg_color="white")
#    Appeared_frame.place(relx=0.2, rely=0.35)

#    Hmepage_background = Ctk.CTkImage(light_image=Image.open('Homepage_background.png'),
#                                        size=(screen_width-350, screen_height-100))
#    Homepage_image_label= Ctk.CTkLabel(master=Appeared_frame, image=Hmepage_background,bg_color="transparent", text="")
#    Homepage_image_label.place(relx=0, rely=0)

#    Feature_frame= Ctk.CTkFrame(master=Appeared_frame, width=(screen_width-350), height= 100 , fg_color="#8c7cbc")
#    Feature_frame.place(relx=0, rely=0)

#    Cont_frame= Ctk.CTkFrame(master=Appeared_frame, width=(screen_width-500), height=(400), fg_color="#8377b8", corner_radius=10, bg_color="white")
...
#    Appeared_label= Ctk.CTkLabel(master=Cont_frame, text="Requests:", text_color="white", font=("bold",25), fg_color="#8377b8")
#    Appeared_label.place(relx=0.05, rely=0.1)
...
#    swap_btn= Ctk.CTkButton(master=Emergency_frame, text=" Personals Health ", width=250, height=100, fg_color="#4B3A91", bg_color="white",
#                              font=("bold",20))
#    swap_btn.place(relx=0.55, rely=0.3)

#    Room_upgrade= Ctk.CTkButton(master=Emergency_frame, text="Guardain's Contacts", width=250, height=100, fg_color="#4B3A91", bg_color="white",
#                              font=("bold",20))
...
# def setting():
#    Setting_frame= Ctk.CTkFrame(master=Homepage, width=(screen_width), height=(screen_height), fg_color="white")
...
#    Homepage_image_label.place(relx=0, rely=0.095)

   

#    Cont_frame= Ctk.CTkFrame(master=Setting_frame, width=(screen_width-800), height=(500), fg_color="#A7DCF5", corner_radius=10, bg_color="white")
#    Cont_frame.place(relx=0.12, rely=0.3)

#    Feature_label= Ctk.CTkLabel(master=Homepage, text="Feature: We offer our honerable student to change their status such as room, bed,occupancy and so on", 
#                                justify= LEFT,text_color="black", font=("bold",25))
#    Feature_label.place (relx=0.2, rely=0.21)

#    Notice_label= Ctk.CTkLabel(master=Cont_frame, text="Setting",text_color="black",  font=("bold",25), fg_color="#A7DCF5")
#    Notice_label.place(relx=0.05, rely=0.1)

#    Search_entry= Ctk.CTkEntry(master=Cont_frame, placeholder_text="Search setting",text_color="black", width=300, height=30,fg_color="#EDF1F5")
#    Search_entry.place(relx=0.3, rely=0.2)

#    Account_btn= Ctk.CTkButton(master=Cont_frame, text="Account",text_color="black", width=400, height=30,fg_color="#EDF1F5",
#                               anchor=W)
#    Account_btn.place(relx=0.15, rely=0.4)

#    Setting_notification_btn= Ctk.CTkButton(master=Cont_frame, text="Notification",text_color="black", width=400, height=30, 
#                                            image=notification_image, fg_color="#EDF1F5", anchor=W)
#    Setting_notification_btn.place(relx=0.15, rely=0.5)

#    Update_password_btn= Ctk.CTkButton(master=Cont_frame, text="Update password",text_color="black", width=400, height=30, fg_color="#EDF1F5",
#                                       anchor=W)
#    Update_password_btn.place(relx=0.15, rely=0.6)

#    Change_contact_btn= Ctk.CTkButton(master=Cont_frame, text="Change contact",text_color="black", width=400, height=30, fg_color="#EDF1F5",
#                                      anchor=W)
...
# Toggle_btn= Ctk.CTkButton(master=Top_frame, text="☰", font=("bold", 20), corner_radius=0, fg_color="#3FB5CB", bg_color="#5c54a4", command=menu)
# Toggle_btn.place(relx=0.2, rely=0.05)

# Hostel_label = Ctk.CTkLabel(master=Top_frame, text="Griha Hostel", font=("helvetica", 25, "bold"), text_color="black", fg_color="#3FB5CB")
# Hostel_label.place(relx=0.01, rely=0.05)

# Lbl1= Ctk.CTkLabel(master=Top_frame, text="Hi, there", font=("helvetica", 15) , text_color="black", fg_color="#3FB5CB" )
# Lbl1.place(relx=0.01, rely=0.29)

# Dashboard_btn= Ctk.CTkButton(master=Top_frame, text="Dashboard", fg_color="#3FB5CB",text_color="black", font=("bold",15),command=menu)
# Dashboard_btn.place(relx=0.35, rely=0.4)

# Room_btn= Ctk.CTkButton(master=Top_frame, text="Rooms", fg_color="#3FB5CB",text_color="black", font=("bold",15),
#                          command=lambda: toggle_button("Rooms", room))
# Room_btn.place(relx=0.48, rely=0.4)

# Special_req_btn= Ctk.CTkButton(master=Top_frame, text="Special Request", fg_color="#3FB5CB",text_color="black", font=("bold",15))
...
# # add `from PIL import Image` on top
# calendar_image = Ctk.CTkImage(light_image=Image.open('Calender.png'),
# size=(20, 20))
...
# # add `from PIL import Image` on top
# What_image = Ctk.CTkImage(light_image=Image.open('What.png'),
#                                   size=(20, 20))

# Notification_btn= Ctk.CTkButton(master=Top_frame, text="", fg_color="#3FB5CB", corner_radius=80, 
#                                 width=40, image=notification_image)
# Notification_btn.place(relx=0.75, rely=0.4)

# Calender_btn= Ctk.CTkButton(master=Top_frame, text="", fg_color="#3FB5CB", 
#                             corner_radius=80, width=30, image=calendar_image)
# Calender_btn.place(relx=0.8, rely=0.4)

# What_btn= Ctk.CTkButton(master=Top_frame,text="", fg_color="#3FB5CB",
#                         corner_radius=80,width=40,image=What_image )
# What_btn.place(relx=0.85, rely=0.4)

# Profile_btn= Ctk.CTkButton(master=Top_frame, text="", fg_color="#3FB5CB", width=40,
...
#      Cont_frame= Ctk.CTkFrame(master=Report_frame, width=(screen_width-800), height=(200), fg_color="#3FB5CB", corner_radius=10, bg_color="white")
...
#       Search_entry.place(relx=0.35, rely=0.2)
...
#       Account_btn.place(relx=0.25, rely=0.4)
   
#       Setting_notification_btn= Ctk.CTkButton(master=Cont_frame, text="Notification", width=400, height=30, text_color="black",
#                                               image=notification_image, fg_color="#EDF1F5", anchor=W)
#       Setting_notification_btn.place(relx=0.25, rely=0.5)
   
#       Update_password_btn= Ctk.CTkButton(master=Cont_frame, text="Update Contact", width=400, height=30, fg_color="#EDF1F5", text_color="black",
#                                          anchor=W, image=contact_image)
#       Update_password_btn.place(relx=0.25, rely=0.6)
   
#       logout_btn= Ctk.CTkButton(master=Cont_frame, text="Log Out", width=400, height=30, fg_color="#EDF1F5", text_color="black",
#                                         anchor=W, image=logout_image)
#       logout_btn.place(relx=0.25, rely=0.7)
...
#     About_frame= Ctk.CTkFrame(master=Homepage, height=400, width=600, fg_color="#EDF1F5")
...
def room():
    ...
    Room1_num= Ctk.CTkLabel(master=Room1_frame, text="50", text_color="white", fg_color="#3FB5CB",
                               width=30, height=30, font=("bold", 30))
